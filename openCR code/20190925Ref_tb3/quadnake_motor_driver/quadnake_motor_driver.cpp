...
bool QuadnakeMotorDriver::init(String turtlebot3)
{
...
bool QuadnakeMotorDriver::readEncoder(int32_t &left_value, int32_t &right_value)
{
...
bool QuadnakeMotorDriver::writeVelocity(int64_t left_value, int64_t right_value)
{
